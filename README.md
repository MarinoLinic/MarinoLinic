...
These are the parts of my tech stack I use, learn, and love:
...
> Related: Git, CSS, Prisma, NextAuth 

> Stuff I've worked with in the past: C++, Pillow (PIL)

<sub>I have experience with Bash, Python OS signals & threading, and can easily work with Unix-like systems.</sub>

<hr>

<sub>↓ The number of stars and forks I have is somewhat misleading because a repo I contributed to counts as _my_ repo according to the software. Everything else is accurate. ↓</sub>
